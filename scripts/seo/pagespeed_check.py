...
# Local credential shim. PSI + CrUX only need a single agency-level
# GOOGLE_PAGESPEED_API_KEY env var.
import os as _os
sys.path.insert(0, _os.path.dirname(_os.path.abspath(__file__)))
from seo_credentials import get_api_key, load_config, validate_url  # noqa: E402
